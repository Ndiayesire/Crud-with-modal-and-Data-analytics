...
<body>
  ...
  <H1 class="text-black text-center shadow p-3 mb-5 animate__animated animate__bounce">Data Analytics
...
<p>
 ...
 Prenom</th>
        ...
        <tbody id="tb" class="table table-striped table-border shadow-lg p-3 mb-5 bg-white rounded " style="width:100%">
          <?php include_once( "SRC/connexion.php"); 
          $result=$db->query("SELECT * FROM clients where 1 ");
      ...
      <div class="shadow-lg p-3 mb-5 bg-white rounded border border-light" id="chartContainer" style="height: 370px; width: 100%;">
      </div>
